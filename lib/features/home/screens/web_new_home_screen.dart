...
import 'package:sixam_mart/features/home/widgets/web/WebViewCategoryItems.dart';
          ...
          SliverToBoxAdapter(
            child: Center(
              child: SizedBox(width: Dimensions.webMaxWidth, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                //     return const WebMostPopularItemViewWidget(isFood: false, isShop: false);
                //   }),
                // ),
                ...
                //
                // (isPharmacy || isFood) ? const SizedBox() : isShop ? const WebNewOnViewWidget() : const SizedBox(),
