                          ...
                          ClipRRect(
                            ...
                            child: GoogleMap(
                              initialCameraPosition: const CameraPosition(
                                  target: LatLng(
                                      18.1096, -77.2975), // Jamaica's center
                                  zoom: 8),
                              minMaxZoomPreference:
                                  const MinMaxZoomPreference(0, 16),
                              cameraTargetBounds: CameraTargetBounds(
                                  LatLngBounds(
                                      southwest: const LatLng(17.0,
                                          -78.5), // Southwest Jamaica boundary
                                      northeast: const LatLng(18.5,
                                          -76.0) // Northeast Jamaica boundary
                                      )),
                  ...
                  GoogleMap(
                    ...
                    cameraTargetBounds: CameraTargetBounds(LatLngBounds(
                        southwest: const LatLng(
                            17.0, -78.5), // Southwest Jamaica boundary
                        northeast: const LatLng(
                            18.5, -76.0) // Northeast Jamaica boundary
                        )),
                    myLocationButtonEnabled: false,
